				...
				'general_tab_start' => array(
					...
					'row_layout_start' => array(
						...
						/*'row_vertical_stretch' => array(
							...
							'tooltip' => esc_attr__( 'Select the type of row to use, this option can be overrided by Design Tool', 'folie' ),
							'default'     => 'with_padd',
							'choices' => array(
						...
						'content_pos' => array(
							...
							'tooltip' => esc_attr__( 'Change position of columns and elements into the fullheight Row', 'folie' ),
							'default'     => 'middle',
							'choices' => array(
								'middle' => 'Middle',
								'top' => 'Top',
