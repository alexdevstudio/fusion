...
if($video == 'self'){
        ...
        $video_wrapper .= '<div class="video"  data-stream="'.$video.'" style="opacity:1;">';
			...
			if ($video == 'youtube')
			    $video_wrapper .= '<iframe src="about:blank" data-src="//www.youtube.com/embed/'.$video_youtube.'?rel=0&amp;wmode=transparent&amp;enablejsapi=1&amp;controls=0&amp;showinfo=0&amp;autoplay='.$autoplay.';loop='.(int)$video_loop.'&amp;playlist='.$video_youtube.'" style="height: '.$height.'px;"></iframe>';
	
	        if ($video == 'vimeo')
	            $video_wrapper .= '<iframe src="about:blank" data-src="//player.vimeo.com/video/'.$video_vimeo.'?badge=0;api=1;background=1;autoplay='.$autoplay.';loop='.(int)$video_loop.'" width="500" height="281" frameborder="0"  style="height: '.$height.'px;" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
