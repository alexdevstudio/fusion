...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'folie' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'folie' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'folie' ),
			'200'       => esc_attr__( 'Light 200', 'folie' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'folie' ),
			'300'       => esc_attr__( 'Book 300', 'folie' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'folie' ),
			'400'       => esc_attr__( 'Normal 400', 'folie' ),
			'regular'   => esc_attr__( 'Normal 400', 'folie' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'folie' ),
			'500'       => esc_attr__( 'Medium 500', 'folie' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'folie' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'folie' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'folie' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'folie' ),
			'700'       => esc_attr__( 'Bold 700', 'folie' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'folie' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'folie' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'folie' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'folie' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'folie' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'folie' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'folie' ),
		);
	}
