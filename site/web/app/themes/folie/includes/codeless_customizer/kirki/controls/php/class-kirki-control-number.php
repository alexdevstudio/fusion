...
class Kirki_Control_Number extends Kirki_Control_Base {
	...
	public function enqueue() {
		...
		wp_localize_script( 'kirki-script', 'numberKirkiL10n', array(
			'min-error'  => esc_attr__( 'Value lower than allowed minimum', 'folie' ),
			'max-error'  => esc_attr__( 'Value higher than allowed maximum', 'folie' ),
			'step-error' => esc_attr__( 'Invalid Value', 'folie' ),
		) );
	}
