...
class Kirki_Modules_Webfonts {
	...
	protected function __construct() {
		...
		// codeless
		include_once wp_normalize_path( CODELESS_KIRKI_PATH . '/modules/webfonts' . '/class-kirki-fonts.php' );
		// codeless
		include_once wp_normalize_path( CODELESS_KIRKI_PATH . '/modules/webfonts' . '/class-kirki-fonts-google.php' );
