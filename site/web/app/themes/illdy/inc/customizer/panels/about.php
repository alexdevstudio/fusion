...
// Facts
$wp_customize->add_setting(
	$prefix . '_about_general_fact_1_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 1 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_1_title', array(
		'label'       => __( 'Fact 1 Title', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_1_title', array(
		'selector'        => '#about .about_fact_1',
		'render_callback' => $prefix . '_about_general_fact_1_title',
	)
);

// Facts Description
$wp_customize->add_setting(
	$prefix . '_about_general_fact_1_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 1 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_1_dscr', array(
		'label'       => __( 'Fact 1 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_1_dscr', array(
		'selector'        => '#about .about_fact_1_dscr',
		'render_callback' => $prefix . '_about_general_fact_1_dscr',
	)
);

// Facts
$wp_customize->add_setting(
	$prefix . '_about_general_fact_2_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 1 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_2_title', array(
		'selector'        => '#about .about_fact_2',
		'render_callback' => $prefix . '_about_general_fact_2_title',
	)
);
// Facts Description
$wp_customize->add_setting(
	$prefix . '_about_general_fact_2_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 2 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_2_dscr', array(
		'label'       => __( 'Fact 2 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_2_dscr', array(
		'selector'        => '#about .about_fact_2_dscr',
		'render_callback' => $prefix . '_about_general_fact_2_dscr',
	)
);

// Facts
$wp_customize->add_setting(
	$prefix . '_about_general_fact_3_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 3 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_3_title', array(
		'selector'        => '#about .about_fact_3',
		'render_callback' => $prefix . '_about_general_fact_3_title',
	)
);

// Facts Description
$wp_customize->add_setting(
	$prefix . '_about_general_fact_3_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 3 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_3_dscr', array(
		'label'       => __( 'Fact 3 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_3_dscr', array(
		'selector'        => '#about .about_fact_3_dscr',
		'render_callback' => $prefix . '_about_general_fact_3_dscr',
	)
);
...
// Facts
$wp_customize->add_setting(
	$prefix . '_about_general_fact_4_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 4 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_4_title', array(
		'label'       => __( 'Fact 4 Title', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_4_title', array(
		'selector'        => '#about .about_fact_4',
		'render_callback' => $prefix . '_about_general_fact_4_title',
	)
);
// Facts Description
$wp_customize->add_setting(
	$prefix . '_about_general_fact_4_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 4 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_4_dscr', array(
		'label'       => __( 'Fact 4 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_4_dscr', array(
		'selector'        => '#about .about_fact_4_dscr',
		'render_callback' => $prefix . '_about_general_fact_4_dscr',
	)
);
...
// Facts
$wp_customize->add_setting(
	$prefix . '_about_general_fact_5_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 5 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_5_title', array(
		'label'       => __( 'Fact 5 Title', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_5_title', array(
		'selector'        => '#about .about_fact_5',
		'render_callback' => $prefix . '_about_general_fact_5_title',
	)
);

// Facts Description
$wp_customize->add_setting(
	$prefix . '_about_general_fact_5_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Fact 5 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_fact_5_dscr', array(
		'label'       => __( 'Fact 5 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_fact_5_dscr', array(
		'selector'        => '#about .about_fact_5_dscr',
		'render_callback' => $prefix . '_about_general_fact_5_dscr',
	)
);
