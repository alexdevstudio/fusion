...
// Project 1 title
$wp_customize->add_setting(
	$prefix . '_about_general_project_1_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 1 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_1_title', array(
		'label'       => __( 'Project 1 Title', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_1_title', array(
		'selector'        => '#about .about_project_1',
		'render_callback' => $prefix . '_about_general_project_1_title',
	)
);

// Project 1 subtitle
$wp_customize->add_setting(
	$prefix . '_about_general_project_1_subtitle', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 1 Subtitle', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_1_subtitle', array(
		'label'       => __( 'Project 1 Subtitle', 'illdy' ),
		'description' => __( 'Add the subtitle for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
);
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_1_subtitle', array(
		'selector'        => '#about .about_project_1',
		'render_callback' => $prefix . '_about_general_project_1_subtitle',
	)
);

// Project 1 Description
$wp_customize->add_setting(
	$prefix . '_about_general_project_1_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 1 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_1_dscr', array(
		'label'       => __( 'Project 1 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_1_dscr', array(
		'selector'        => '#about .about_project_1_dscr',
		'render_callback' => $prefix . '_about_general_project_1_dscr',
	)
);
...
// Project 2 title
$wp_customize->add_setting(
	$prefix . '_about_general_project_2_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 2 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_2_title', array(
		'label'       => __( 'Project 2 Title', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_2_title', array(
		'selector'        => '#about .about_project_2',
		'render_callback' => $prefix . '_about_general_project_2_title',
	)
);

// Project 2 subtitle
$wp_customize->add_setting(
	$prefix . '_about_general_project_2_subtitle', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 2 Subtitle', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_2_subtitle', array(
		'label'       => __( 'Project 2 Subtitle', 'illdy' ),
		'description' => __( 'Add the subtitle for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_2_subtitle', array(
		'selector'        => '#about .about_project_2',
		'render_callback' => $prefix . '_about_general_project_2_subtitle',
	)
);

// Project 2 Description
$wp_customize->add_setting(
	$prefix . '_about_general_project_2_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 2 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_2_dscr', array(
		'label'       => __( 'Project 2 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_2_dscr', array(
		'selector'        => '#about .about_project_2_dscr',
		'render_callback' => $prefix . '_about_general_project_2_dscr',
	)
);
...
// Project 3 title
$wp_customize->add_setting(
	$prefix . '_about_general_project_3_title', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 3 Title', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_3_title', array(
		'label'       => __( 'Project 3 Title', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_3_title', array(
		'selector'        => '#about .about_project_3',
		'render_callback' => $prefix . '_about_general_project_3_title',
	)
);

// Project 3 subtitle
$wp_customize->add_setting(
	$prefix . '_about_general_project_3_subtitle', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 3 Subtitle', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_3_subtitle', array(
		'label'       => __( 'Project 3 Subtitle', 'illdy' ),
		'description' => __( 'Add the subtitle for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_3_subtitle', array(
		'selector'        => '#about .about_project_3',
		'render_callback' => $prefix . '_about_general_project_3_subtitle',
	)
);

// Project 3 Description
$wp_customize->add_setting(
	$prefix . '_about_general_project_3_dscr', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Project 3 Description', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	$prefix . '_about_general_project_3_dscr', array(
		'label'       => __( 'Project 3 Description', 'illdy' ),
		'description' => __( 'Add the title for this section.', 'illdy' ),
		'section'     => $panel_id,
		'priority'    => 2,
	)
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_about_general_project_3_dscr', array(
		'selector'        => '#about .about_project_3_dscr',
		'render_callback' => $prefix . '_about_general_project_3_dscr',
	)
);
