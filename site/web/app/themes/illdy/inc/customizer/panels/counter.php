...
$wp_customize->add_setting(
	$prefix . '_counter_general_title', array(

		'default'           => __( 'Counter', 'illdy' ),
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_counter_general_title', array(
		'selector' => '#counter .section-header h3',
	)
);
...
// Client 1 Logo
$wp_customize->add_setting(
	$prefix . '_counter_client_1_image', array(
		'sanitize_callback' => 'esc_url_raw',
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		$wp_customize, $prefix . '_counter_client_1_image', array(
			'label'           => __( 'Client 1 Logo', 'illdy' ),
			'section'         => $prefix . '_counter_general',
			'settings'        => $prefix . '_counter_client_1_image',
			'priority'        => 2,
		)
	)
);
...
// Client 2 Logo
$wp_customize->add_setting(
	$prefix . '_counter_client_2_image', array(
		'sanitize_callback' => 'esc_url_raw',
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		$wp_customize, $prefix . '_counter_client_2_image', array(
			'label'           => __( 'Client 2 Logo', 'illdy' ),
			'section'         => $prefix . '_counter_general',
			'settings'        => $prefix . '_counter_client_2_image',
			'priority'        => 2,
		)
	)
);
...
// Client 3 Logo
$wp_customize->add_setting(
	$prefix . '_counter_client_3_image', array(
		'sanitize_callback' => 'esc_url_raw',
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
	new WP_Customize_Image_Control(
		$wp_customize, $prefix . '_counter_client_3_image', array(
			'label'           => __( 'Client 3 Logo', 'illdy' ),
			'section'         => $prefix . '_counter_general',
			'settings'        => $prefix . '_counter_client_3_image',
			'priority'        => 2,
		)
	)
);
