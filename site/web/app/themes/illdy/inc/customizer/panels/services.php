...
// Title
$wp_customize->add_setting(
	$prefix . '_services_general_btn', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( 'Button Text', 'illdy' ),
		'transport'         => 'postMessage',
	)
);
$wp_customize->add_control(
...
$wp_customize->selective_refresh->add_partial(
	$prefix . '_services_general_btn', array(
		'selector' => '#services .custom_btn',
	)
);

// Title
$wp_customize->add_setting(
	$prefix . '_services_general_btn_link', array(
		'sanitize_callback' => 'illdy_sanitize_html',
		'default'           => __( '#', 'illdy' ),
		'transport'         => 'postMessage',
	)
