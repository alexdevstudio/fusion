...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$services_general_btn = get_theme_mod( 'illdy_services_general_btn' );
	$services_general_btn_link = get_theme_mod( 'illdy_services_general_btn_link' );
...
<section id="services" class="front-page-section">
	...
	<div class="section-content">
		<div class="container">
			...
			<div class="row inline-columns illdy_services_general_btn">
				<a class="illdy_services_general_btn_link" href="<?php echo "$services_general_btn_link"; ?>"><?php echo "$services_general_btn"; ?></a>
			</div>
		</div><!--/.container-->
	</div><!--/.section-content-->
